...
public class OrderDateList
{
    ...
    private Date data[];         // Reference for data array
    ...
    */
    public OrderDateList(String filename, SortState state)
    {
        ...
        try
        {
            ...
            {
                // Get month info from one line of file
                mo = inputFileScanner.nextInt();   
                da = inputFileScanner.nextInt();   
                yr = inputFileScanner.nextInt();   
                
                // Instantiate Date object and add to list
                Date newDate = new Date(mo,da,yr);
                data[i] = newDate;
    ...
    */
    public void insert(Date newElement)
    {
    ...
    */
    public void delete(Date oldElement)
    {
