...
public class Rational
{
    ...
    *  @param n integer numerator for initial fraction
    *  @param d integer numerator for initial fraction
    */   
    ...
    *  @param  m  First integer for GCD determination
    *  @param  n  Second integer for GCD determination
   ...
   *  @param  fraction2 Second Operand for comparison
   */
   ...
   *  @return Interger: 1 if the first is greater than the second, zero if the two
