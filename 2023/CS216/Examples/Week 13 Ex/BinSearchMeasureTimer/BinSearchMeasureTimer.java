...
public class BinSearchMeasureTimer
{   
    final static int ARRAY_SIZE = 32767;
    ...
    static double linearAveTime = 0;  // To measure average seach time - linear
    static double binaryAveTime = 0;  // To measure average seach time -  binar
    ...
    public static void main( String args[])
    {
        ...
        for (int i = 1; i <= NUM_TESTS; i++)
        {
            ...
            stopWatch.stop();
            linearAveTime += stopWatch.getElapsedTime();
        ...
        // Calculate averages
        double aveLinCompares = (double)numTestsLin/(double)NUM_TESTS;
        double aveBinCompares = (double)numTestsBin/(double)NUM_TESTS;
        double aveLinTime     = linearAveTime/(double)NUM_TESTS;
        double aveBinTime     = binaryAveTime/(double)NUM_TESTS;
        ...
        message += "Linear search: " + 
                   String.format(" Comparisons: %6.1f\n Ave Time: %6.4f\n",
                   aveLinCompares,aveLinTime);
                   
        message += "Binary search: " + 
                   String.format(" Comparisons: %6.1f\n Ave Time: %6.4f\n",
                   aveBinCompares,aveBinTime);
