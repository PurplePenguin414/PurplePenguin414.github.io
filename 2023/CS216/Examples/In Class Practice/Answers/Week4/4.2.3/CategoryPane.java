...
public class CategoryPane extends Pane
{
    ...
    private String alertLabels[] = {"Fire Marshall", "Special Victims Unit", "Bomb Squad", "SWAT", "K-9"};
   
    private Label responseLevel;
    private RadioButton lowButton;
    private RadioButton medButton;
    private RadioButton hiButton;
    private RadioButton extremeButton;
    ...
    public CategoryPane()
    {
        ...
        extremeButton   = new RadioButton("Extreme");
        ...
        extremeButton.setToggleGroup(responseButtonGroup);
        responseButtonBox = new VBox(15,responseLevel,lowButton,medButton,hiButton,extremeButton);
    ...
    public String getPriorityData()
    {
        ...
        if (hiButton.isSelected() )   
            returnString += "High";
        if (extremeButton.isSelected() )
            returnString += "Extreme";
